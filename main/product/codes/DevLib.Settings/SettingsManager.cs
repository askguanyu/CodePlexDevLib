    ...
    public class SettingsManager
    {
        ...
        public SettingsManager(string configFile)
        {
            ...
            catch (Exception e)
            {
                ...
                this._configuration = ConfigurationManager.OpenExeConfiguration(Path.GetTempFileName());
            }
        }
        ...
        public void Save()
        {
            ...
            {
                Debug.WriteLine(string.Format(SettingsConstants.ExceptionStringFormat, "SettingsManager.Save", e.Source, e.Message, e.StackTrace));
