//-----------------------------------------------------------------------
// <copyright file="WcfClientReusableProxy.cs" company="YuGuan Corporation">
...
namespace DevLib.ServiceModel
{
    ...
    /// <summary>
    /// Class WcfClientReusableProxy.
    /// </summary>
    /// <typeparam name="TChannel">The channel to be used to connect to the service.</typeparam>
    public abstract class WcfClientReusableProxy<TChannel> : IWcfClientBase where TChannel : class
    {
        /// <summary>
        /// Field _InstanceType.
        /// </summary>
        ...
        /// <summary>
        /// Initializes static members of the <see cref="WcfClientReusableProxy{TChannel}" /> class.
        /// </summary>
        static WcfClientReusableProxy()
        {
            InstanceType = WcfClientProxyTypeBuilder.BuildType<TChannel, WcfClientClientBaseClassBuilder<TChannel>>();
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="WcfClientReusableProxy{TChannel}" /> class.
        /// </summary>
        protected WcfClientReusableProxy()
        {
        ...
        protected WcfClientReusableProxy(string endpointConfigurationName)
        {
        ...
        protected WcfClientReusableProxy(string endpointConfigurationName, EndpointAddress remoteAddress)
        {
        ...
        protected WcfClientReusableProxy(Binding binding, EndpointAddress remoteAddress)
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="WcfClientReusableProxy{TChannel}" /> class.
        /// </summary>
        ~WcfClientReusableProxy()
        {
            this.Dispose(false);
        }
        ...
        /// <summary>
        /// Releases all resources used by the current instance of the <see cref="WcfClientReusableProxy" /> class.
        /// </summary>
        public void Dispose()
        {
            this.Dispose(true);
        ...
        private void CheckDisposed()
        {
            if (this._disposed)
            {
                throw new ObjectDisposedException("DevLib.ServiceModel.WcfClientReusableProxy");
            }
        }
    }
}
