        ...
        private void WriteToConsole(ConsoleColor foregroundColor, string value, bool withNewLine = true, bool withTimestamp = true)
        {
            ...
            if (withNewLine)
            {
                if (withTimestamp)
                {
                    ...
                    Console.WriteLine(string.Format("[{0}] {1}", DateTime.Now.ToString("o", CultureInfo.InvariantCulture), value));
                }
                else
                {
                    Console.ForegroundColor = foregroundColor;
            ...
            else
            {
                ...
                {
                    Console.ForegroundColor = foregroundColor;
                    Console.Write(string.Format("[{0}] {1}", DateTime.Now.ToString("o", CultureInfo.InvariantCulture), value));
                }
                else
                {
                    Console.ForegroundColor = foregroundColor;
